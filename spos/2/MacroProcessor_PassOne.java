...
public class MacroProcessor_PassOne {
    ...
    static void pass1() throws Exception {
        ...
        // Adjusted the file paths according to your working directory
        ...
        while ((s = input.readLine()) != null) {
            ...
            // Analyze the first token to check if it is a macro definition
            ...
            if (curToken.equalsIgnoreCase("MACRO")) {
                ...
                // If the line is not part of a Macro definition, print it as it is in the output file
    ...
    static void processArgumentList(String argList) {
        ...
        // Put all arguments for the current macro definition in the HashMap
        // with the argument as key and argument index as value
        String curArg;
